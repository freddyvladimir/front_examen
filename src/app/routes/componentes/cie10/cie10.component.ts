...
import { EmergenciasService } from 'app/routes/segundo-nivel/emergencias/emergencias.service';
...
export class Cie10Component implements OnInit {
  ...
  constructor(private _snackBar: MatSnackBar, private emergenciasService: EmergenciasService, public dialogRef: MatDialogRef < Cie10Component > ) {
